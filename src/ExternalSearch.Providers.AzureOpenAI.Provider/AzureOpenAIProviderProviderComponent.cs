...
public sealed class AzureOpenAIProviderProviderComponent : ServiceApplicationComponent<IServer>
{
    /**********************************************************************************************************
     * CONSTRUCTOR
     **********************************************************************************************************/
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="AzureOpenAIProviderProviderComponent" /> class.
    /// </summary>
    /// <param name="componentInfo">The component information.</param>
    public AzureOpenAIProviderProviderComponent(ComponentInfo componentInfo) : base(componentInfo)
    {
    ...
    {
        var asm = Assembly.GetAssembly(typeof(AzureOpenAIProviderProviderComponent));
