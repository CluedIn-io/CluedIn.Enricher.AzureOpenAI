// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AzureOpenAITests.cs" company="Clued In">
//   Copyright (c) 2019 Clued In. All rights reserved.
// </copyright>
// <summary>
//   Implements the AzureOpenAI tests class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------

// #define AzureOpenAI_DEV
...
using CluedIn.ExternalSearch.Providers.Azure OpenAI;
using CluedIn.Testing.Base.ExternalSearch;
using Moq;
using Xunit;

namespace ExternalSearch.AzureOpenAI.Integration.Tests
{
    public class AzureOpenAITests : BaseExternalSearchTest<AzureOpenAIExternalSearchProvider>
    {
